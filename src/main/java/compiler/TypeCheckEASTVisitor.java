...
//visitNode(n) performs type checking of a Node n and returns:
//- for an expression, its type (BoolTypeNode or IntTypeNode object)
//- for a declaration, "null"; checks the internal correctness of the declaration
//(- for a type: "null"; checks that the type is not incomplete)
//
//visitSTentry(s) returns, for an STentry s, the type contained within it
...
// handling incomplete types (if they are throws exception)
